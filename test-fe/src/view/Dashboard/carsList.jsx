...
const CarsList = ({ list }) => {
  ...
  const headList = [
    ...
    { name: 'Model', center: true, classes: 'justify-content-center' },
    { name: 'Color', center: true, classes: 'justify-content-center' },
  ];
    ...
    <div className='mt-4'>
      <div className='border rounded-lg  dataTables_wrapper'>
          ...
          <tbody className='border-0 table-border'>
            {listData.map((item) => (
              <tr role='row'>
                ...
                <td className='text-left col-6'>{item?.regNo}</td>
                <td className='text-center col-2'>{item?.model}</td>
                <td className='text-center col-2'>{item?.color}</td>
              </tr>
            ))}
          </tbody>
        </Table>
        ...
        <div className='d-sm-flex text-center align-items-center justify-content-between px-3'>
          ...
          <ul className='pagination gap-2 justify-content-center mt-3 mt-md-0'>
            <li class='page-item'>
              <Link
                className='page-link'
                to='/'
